<template>
  <nav
    class="fixed w-full px-4 lg:px-24 xl:px-72 py-2 lg:py-4 font-inter bg-gray-800/95 text-gray-100 z-10 backdrop-blur-sm"
  >
    <div class="flex flex-row justify-between items-center">
      ...
      <Popover class="block md:hidden">
        ...
        >
          <PopoverPanel
            class="absolute left-0 top-14 w-screen z-20 p-4 bg-gray-900/95 backdrop-blur-lg"
          >
            <template v-for="(page, index) of pages" :key="index">
              <a
                :href="page.href"
